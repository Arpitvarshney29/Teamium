...
//	 *
//	 * @param exception the BadRequestException object as parameter
//	 * 
...
//	 *
//	 * @param exception the ForbiddenException object as parameter
//	 * 
//	 * @return the response entity.
//	 * 
//	 * @throws JsonProcessingException
...
//	 *
//	 * @param exception the UnauthorizedException object as parameter
//	 * 
//	 * @return the response entity.
//	 * 
//	 * @throws JsonProcessingException
...
//		logger.error(exception.getMessage(), exception);
//		forbiddenResponse.setMessage(exception.getMessage());
//		//forbiddenResponse.setMessage("Teamium server is unable to process this request.");
//		return new ResponseEntity<>(forbiddenResponse, HttpStatus.BAD_REQUEST);
//	}
//
//	/**
